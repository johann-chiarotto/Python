...
class Game:
    ...
    def __init__(self, screen):
        ...
        if niveau==0:
            self.player1 = Player1(10,300)
            self.player2 = Player2(10,350)
        elif niveau==1:
    ...
    def update(self):
        ...
        if niveau == 0:
            if maps0.fin_jeu(self) == 1:
                """niveau = 1"""
                self.set_running (False)
            if maps0.fin_jeu(self) == 2:
                """niveau = 2"""
                self.set_running (False)
            if maps0.fin_jeu(self) == 3:
                """niveau = 3"""
                self.set_running (False)
            if maps0.fin_jeu(self) == 4:
                """niveau = 4"""
                self.set_running (False)
            if maps0.fin_jeu(self) == 5:
                """niveau = 5"""
                self.set_running (False)
            if maps0.fin_jeu(self) == 6:
                """niveau = 6"""
                self.set_running (False)
            if maps0.fin_jeu(self) == False:
                """jouer = False"""
                self.set_running (False)
        if niveau==1:
